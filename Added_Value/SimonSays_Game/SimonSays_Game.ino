...
void loop() {
  ...
  while(level <= maxLevel){
    ...
    int i = 0;
    userCount = 0;
    while(i < level && loser == false) {
      // if we get input add one to i and userCount
      while(getUserCode() && loser == false) {
...
void drawWelcomeScreen() {
  ...
  // draw the score on the same line as message4
...
bool getUserCode() {
  ...
  // MTCH structure so that we can process it
    ...
    switch (mtch.msg) {   
      ...
      case msgFinger1Down: 
      //================ B1
      if((mtch.xco > 0) && (mtch.xco < 158) && (mtch.yco > 0) && (mtch.yco < 118)) {
          time_Now = millis();
          tone(piezoPin, 4500, 300);
          buttonB1Pressed();
          delay(100);
      ...
      //================ B2
      if((mtch.xco > 0) && (mtch.xco < 158) && (mtch.yco > 122) && (mtch.yco < 230)) {
          time_Now = millis();
          tone(piezoPin, 4000, 300);
          buttonB2Pressed();
          delay(100);
      ...
      //================ B3
      if((mtch.xco > 162) && (mtch.xco < 320) && (mtch.yco > 122) && (mtch.yco < 230)) {
          time_Now = millis();       
          tone(piezoPin, 3000, 300);
          buttonB3Pressed();
          delay(100);
      ...
      //================ B4
      if((mtch.xco > 162) && (mtch.xco < 320) && (mtch.yco > 0) && (mtch.yco < 118)) {
          time_Now = millis();         
          tone(piezoPin, 2000, 300);
          buttonB4Pressed();
          delay(100);
